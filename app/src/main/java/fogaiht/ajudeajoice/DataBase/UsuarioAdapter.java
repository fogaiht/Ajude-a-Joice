...
public class UsuarioAdapter extends ArrayAdapter<Usuario> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewTelefone = (TextView) convertView.findViewById(R.id.textViewMensagem);
        textViewTelefone.setText(itemPosicao.getMensagem());
...
//                intent.putExtra("mensagem",itemPosicao.getMensagem());
